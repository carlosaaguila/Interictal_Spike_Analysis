...
cat1 = load('Exp1Filt.mat'); cat2 = load('Exp2Unfilt.mat'); cat3 = load('Exp3Unfilt.mat'); cat4 = load('Exp4Unfilt.mat'); cat5 = load('Exp5Unfilt.mat'); 
cat1 = cat1.allEventData; cat2 = cat2.allEventData; cat3 = cat3.allEventData; cat4 = cat4.allEventData; cat5 = cat5.allEventData;
...
pathway = '/gdrive/public/USERS/aguilac/Projects/cat_data/catspikes.mat';
save(pathway, '-struct', 'catspikes')

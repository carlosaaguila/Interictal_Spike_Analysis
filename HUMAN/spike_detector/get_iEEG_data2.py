...
def get_iEEG_data2(
    ...
    Andy Revell, adapted by Akash Pattnaik (2021.06.23), adapted by Sarah Lavelle (2025.02.18)
    ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
    Purpose:
    ...
    3. Catches iEEG.org errors and logs number of attempts 
    ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
    Input
    ...
    while True:
        try: 
            ...
            if any(str(code) in str(e) for code in ['503', '504', '502', '500']):
                attempt += 1
                print(f'Failed to retrieve ieeg.org data, trying again (attempt {attempt})')
            else:
                print(e)
                raise Exception('Non-server error')

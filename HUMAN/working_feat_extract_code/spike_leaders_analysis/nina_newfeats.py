...
# Load data
nina_spikes = pd.read_csv('/mnt/leif/littlab/users/aguilac/Interictal_Spike_Analysis/HUMAN/working_feat_extract_code/working features/nina_allspikes/nina_allspikes.csv')

all_spikes = nina_spikes
...
all_spikes.to_csv('/mnt/leif/littlab/users/aguilac/Interictal_Spike_Analysis/HUMAN/working_feat_extract_code/working features/nina_allspikes/nina_allspikes_v2.csv')
...
for Feat_of_interest in list_of_feats:
    ...
    if side == 'same':
        ...
        #remove bilateral for this analysis.
    ...
    if vs_other == False:
        ...
        plt.savefig(f'../figures/MUSC/pos_controls/stat_test/spearman/{side}_{Feat_of_interest}-ranksum.pdf')
        ...
        plt.savefig(f'../figures/MUSC/pos_controls/stat_test/pearson/{side}_{Feat_of_interest}-ranksum.pdf')
    ...
    if vs_other == True:
        ...
        plt.savefig(f'../figures/MUSC/pos_controls/stat_test/vs_other/spearman/{side}_{Feat_of_interest}-ranksum.pdf')
        ...
        plt.savefig(f'../figures/MUSC/pos_controls/stat_test/vs_other/pearson/{side}_{Feat_of_interest}-ranksum.pdf')

...
for i, Feat_of_interest in enumerate(list_of_feats):
    ...
    # ALL_FEATS = 
    ALL_FEATS.append(all_spikes_avg)

merged_df = ALL_FEATS[0].copy()

for i, df in enumerate(ALL_FEATS[1:], start=2):
...
# %%
# Assuming corr_df is already defined
# Ensure that 'SOZ' is of categorical type for better plot interpretation
...
# Show the plot
sns.despine()
plt.savefig(f'figures/sameside_perSOZ/bilateral/statistical_test/spearman/ALL_spearman_CLEAN.pdf')
plt.show()
...
# Show the plot
sns.despine()
plt.savefig(f'figures/sameside_perSOZ/bilateral/statistical_test/pearson/ALL_pearson_CLEAN.pdf')
plt.show()
...
# Show the plot
sns.despine()
plt.savefig(f'figures/sameside_perSOZ/bilateral/statistical_test/new_metrics/ALL_slope_CLEAN.pdf')
plt.show()
...
# Show the plot
sns.despine()
plt.savefig(f'figures/sameside_perSOZ/bilateral/statistical_test/new_metrics/ALL_first_values_CLEAN.pdf')
plt.show()

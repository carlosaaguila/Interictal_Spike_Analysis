...
results_df.to_csv('../data/self_run/EI_new_onset_detector/EI_HUP_80_80s.csv', index=False)
...
results_df = pd.DataFrame([result for result in all_results if result is not None])
results_df.to_csv('../data/self_run/EI_new_onset_detector/EI_MUSC_80_80s.csv', index=False)
print("All results saved.")
...
# import sys
# sys.path.append('/mnt/leif/littlab/users/slavelle/iEEG_Atlas/EI_Calculations/scripts')
...
results_df.to_csv('../data/self_run/all_EI_results_Carlos_MUSC_all_channels.csv', index=False)
